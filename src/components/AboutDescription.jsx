    ...
    <div className='mt-[84px]'>
        <Grid container spacing={2}>
          <Grid item xs={12}>
            ...
            <p className="mb-4">
              An e-commerce website similar to Uber Eats / PedidosYa / Rappi
              that was developed in an intensive coding bootcamp called Hack
              Academy.
            </p>
            <p className="font-bold mb-2">
              We used the following technologies:
            </p>
            <ul className="list-none grid grid-cols-3 gap-2 mb-4">
            ...
            <ul className="list-none list-inside mb-6">
              <li className="mb-2">
                <span className="font-bold">Responsive design:</span> Our
                website adapts to different screen sizes and devices, providing
                a seamless user experience.
              </li>
              <li className="mb-2">
                <span className="font-bold">User registration and login:</span>{" "}
                Users can create accounts, log in, and save their preferences
                and orders.
              </li>
              <li className="mb-2">
              ...
              <li className="mb-2">
                ...
                and remove items from their cart, and keep track of the total
                cost and quantity.
              </li>
              <li className="mb-2">
            ...
            <ul className="list-none list-inside mb-6">
              <li className="mb-2">
                <span className="font-bold">Payment gateway:</span> Integrating
                a payment gateway can be complex and requires careful attention
                to security and user experience.
              </li>
              <li>
                <span className="font-bold">Search functionality:</span>{" "}
                Building a fast and accurate search engine for large datasets
                can be a challenge, requiring knowledge of indexing, ranking,
